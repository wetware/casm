...
// 	assert.True(t, rt.Upsert(newTestRecord(id, 0)),
...
// func newTestRecord(id peer.ID, seq uint64) testRecord {
// 	return testRecord{
// 		id:  id,
// 		seq: seq,
// 	}
